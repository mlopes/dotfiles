Config {
    ...
    commands = [
        ...
        Run Wireless "wlp3s0" [ "-t", "<icon=/home/mlopes/.xmonad/icons/net-wifi.xbm/> <fc=#ffca28><essid></fc> [<qualitybar>]","-L","0","-H","32","--normal","yellow","--high","#ffca28","--low","red"] 10,
    ...
    sepChar = "%",
    alignSep = "}{",
    template = "%StdinReader% }{%multicpu% %memory% %swap%  %wlp3s0wi% <icon=/home/mlopes/.xmonad/icons/vol-hi.xbm/><fc=#ffca28>%volume%</fc> %battery% %date% %EGLL%"
}
