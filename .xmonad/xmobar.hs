Config {
    ...
    commands = [
        ...
        Run MultiCpu ["-t","<fn=1>\xf0e4</fn><total0> <vbar0><total1> <vbar1>","-L","30","-H","60","-h","#FF6600","-l","#FFD77C","-n","#FE8C1F","-w","3"] 10,
        ...
        Run Wireless "wlp2s0" [ "-t", "<fn=1>\xf1eb</fn> <fc=#FE8C1F><essid></fc> [<qualitybar>]","-L","0","-H","32","--normal","#FE8C1F","--high","#FF6600","--low","#FFD77C"] 10,
