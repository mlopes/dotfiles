...
myManageHook = composeAll
    ...
    , title     =? "Zoom Meeting"           --> doShift "6:apps"
    , className =? "Zoom Meeting"           --> doShift "6:apps"
    , resource  =? "Zoom Meeting"           --> doShift "6:apps"
    , title     =? "Zoom - Free Account"    --> doShift "6:apps"
    , className =? "Zoom - Free Account"    --> doShift "6:apps"
    , resource  =? "Zoom - Free Account"    --> doShift "6:apps"
